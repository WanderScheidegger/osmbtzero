...
class AdmAexecutar extends StatefulWidget {

  @override
  _AdmAexecutarState createState() => _AdmAexecutarState();
}


class _AdmAexecutarState extends State<AdmAexecutar> {
                              ...
                              child: ButtonBar(
                                children: <Widget>[
                                  RaisedButton(
                                      ...
                                      onPressed: () {
                                        Navigator.pushReplacementNamed(context, "/editanota",
                                            arguments: ordem);
                                      }),
                                  RaisedButton(
                                      child: Text(

...
class VisualizarN extends StatefulWidget {
  Ordem ordem;
  VisualizarN(this.ordem);

  @override
  _VisualizarNState createState() => _VisualizarNState();
}

class _VisualizarNState extends State<VisualizarN> {
